...
// import React, { useState } from 'react';
// import { fetchUserData } from '../services/githubService';  // Import the fetchUserData function from githubService.js
...
//     try {
//       // Fetch user data from GitHub API using the function imported from githubService.js
//       const data = await fetchUserData(username, location, minRepos);
//       setUserData(data);
//     } catch (err) {
//       setError(true);
...
//       {/* Form for user input */}
//       <form onSubmit={handleSubmit} className="space-y-4">
//         {/* Input fields for username, location, and minimum repositories */}
//       </form>
