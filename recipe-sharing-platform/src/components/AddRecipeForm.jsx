...
const AddRecipeForm = () => {
  ...
  return (
<div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg md:max-w-2xl md:p-8">
  <h1 className="text-2xl font-bold mb-4 md:text-3xl">Add a New Recipe</h1>
  {errors && (
    <div className="bg-red-100 text-red-700 p-2 mb-4 rounded md:text-base">
      {errors}
    </div>
  )}
  {successMessage && (
    <div className="bg-green-100 text-green-700 p-2 mb-4 rounded md:text-base">
      {successMessage}
    </div>
  )}
  <form onSubmit={handleSubmit}>
    ...
    <button
      type="submit"
      className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 md:px-6 md:py-3 md:text-lg"
    >
      Add Recipe
    </button>
  </form>
